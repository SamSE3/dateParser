...
public class TiltTest {
    ...
    public void testTiltLeft() {
        ...
        org.junit.Assert.assertArrayEquals("doesn't mix values C", new int[]{2, 2, 0, 0}, Tilt.tiltLeft(new int[]{2, 0, 1, 1}));
    }
    ...
    public void testTiltRight() {
        ...
        org.junit.Assert.assertArrayEquals("doesn't mix values C", new int[]{0, 0, 2, 2}, Tilt.tiltRight(new int[]{2, 0, 1, 1}));
    }
